...
TitleScreen_PlacePikaSpeechBubble:
	hlcoord 5, 1
	ld de, TitleScreenPocketMonstersTilemap
	lb bc, 1, 10
	call Bank29_CopyBox
	hlcoord 6, 5
...
TitleScreenPokemonLogoTilemap: ; 14x4
	INCBIN "gfx/title/pokemon_logo.tilemap"

TitleScreenPocketMonstersTilemap:
	db $47, $48, $49, $4a, $4b, $4c, $4d, $4e, $4f, $5f ; POCKET MONSTERS

TitleScreenPikaBubbleTilemap: ; 7x3
