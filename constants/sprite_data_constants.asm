...
DEF PLAYER_DIR_RIGHT EQU 1 << PLAYER_DIR_BIT_RIGHT ; 1
DEF PLAYER_DIR_LEFT  EQU 1 << PLAYER_DIR_BIT_LEFT  ; 2
DEF PLAYER_DIR_DOWN  EQU 1 << PLAYER_DIR_BIT_DOWN  ; 4
DEF PLAYER_DIR_UP    EQU 1 << PLAYER_DIR_BIT_UP    ; 8
