...
; OAM attribute masks
DEF OAM_OBP1      EQU 1 << OAM_OBP_NUM  ; $10 ; OBJ palette 1
DEF OAM_HFLIP     EQU 1 << OAM_X_FLIP   ; $20 ; horizontal flip
DEF OAM_VFLIP     EQU 1 << OAM_Y_FLIP   ; $40 ; vertical flip
DEF OAM_BEHIND_BG EQU 1 << OAM_PRIORITY ; $80 ; behind bg (except color 0)
