...
TextPredefs::
	...
	add_tx_pre SafariZoneWestRestHouseStoolText     ; 1D XXX unused
	add_tx_pre SafariZoneEastRestHouseStoolText     ; 1E XXX unused
	add_tx_pre SafariZoneNorthRestHouseStoolText    ; 1F XXX unused
